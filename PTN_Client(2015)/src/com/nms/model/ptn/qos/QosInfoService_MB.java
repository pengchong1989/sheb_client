...
public class QosInfoService_MB extends ObjectService_Mybatis{
	 ...
	 * @throws Exception
	 */
	private int save(List<QosInfo> qosInfoList) throws Exception, BusinessIdException {
		if (null == qosInfoList || qosInfoList.size() == 0) {
	 ...
	 * @return
	 */
	public String qosCirSum(List<QosInfo> qosList) {
		String result = "totalCir=";
		int sum = 0;
